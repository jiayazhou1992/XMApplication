...
import com.xiaomawang.commonlib.ui.widget.pickers.common.LineConfig;
import com.xiaomawang.commonlib.ui.widget.pickers.util.ConvertUtils;
 ...
 */
public class WheelListView extends ListView implements ListView.OnScrollListener, View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private static final int REFRESH_POS = 1;
    private static final int SCROLL_SELECTED_CALLBACK = 2;
    private static final long delayed = 150l;
    ...
    static class SHandler extends Handler {
        ...
        WeakReference<WheelListView> reference;

        SHandler(WheelListView wheelListView){
            reference = new WeakReference<>(wheelListView);
        }

        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if (msg.what == SCROLL_SELECTED_CALLBACK){
                WheelListView wheelListView = reference.get();
                if (wheelListView != null) {
                    wheelListView.onSelectedCallback();
                }
            }
        }
    }
    ...
    public void setSelectedIndex(final int index) {
        ...
        postDelayed(new Runnable() {
            @Override
            public void run() {
                sHandler.removeMessages(SCROLL_SELECTED_CALLBACK);
    ...
    public String getSelectedItem() {
        return adapter.getItem(getCurrentPosition()).toString();
    }
    ...
    private void refreshCurrentPosition() {
        ...
        //onSelectedCallback();
        sHandler.removeMessages(SCROLL_SELECTED_CALLBACK);
        sHandler.sendEmptyMessageDelayed(SCROLL_SELECTED_CALLBACK, delayed);
    }
    ...
    private void refreshTextView(int position, int curPosition, View
        ...
        if (curPosition == position) { // 选中
            ...
            //DevLogger.iTag(TAG,"position---->" + position + "curPosition----->" + curPosition);
    ...
    private static class WheelAdapter extends BaseAdapter {
        ...
        public final View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.itemView.setText(data.get(position).toString());
