...
import com.xiaomawang.commonlib.ui.widget.pickers.adapter.WheelAdapter;
import com.xiaomawang.commonlib.ui.widget.pickers.common.InertiaTimerTask;
import com.xiaomawang.commonlib.ui.widget.pickers.common.LineConfig;
import com.xiaomawang.commonlib.ui.widget.pickers.common.MessageHandler;
import com.xiaomawang.commonlib.ui.widget.pickers.common.OnItemPickedRunnable;
import com.xiaomawang.commonlib.ui.widget.pickers.common.SmoothScrollTimerTask;
import com.xiaomawang.commonlib.ui.widget.pickers.listeners.OnItemPickListener;
import com.xiaomawang.commonlib.ui.widget.pickers.listeners.WheelViewGestureListener;
import com.xiaomawang.commonlib.ui.widget.pickers.model.IPickerViewData;
...
public class WheelView<T> extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.textsize1);//默认大小
...
//        AT MOST：父节点要求其子节点的大小不能超过某个最大值，其子节点以及其他子孙节点的大小都需要小于这个值
    ...
    public final Object getCurrentItem() {
        selectedItem = adapter.getItem(selectedPosition);
        return selectedItem;
    }
    //handler 里调用
