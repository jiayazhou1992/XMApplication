...
import com.xiaomawang.commonlib.ui.widget.pickers.listeners.OnMoreItemPickListener;
 ...
 * @see DataProvider
 */
public abstract class LinkagePicker extends WheelPicker {
    ...
    public void setSelectedItem(String firstText, String secondText, String thirdText) {
        ...
        for (int i = 0; i < firstData.size(); i++) {
            ...
            if (ft.contains(firstText)) {
              ...
              //  LogUtils.verbose("init1 select first text: " + ft + ", index:" + selectedFirstIndex);
                break;
            }
        }
        ...
        for (int j = 0; j < secondData.size(); j++) {
            ...
            if (st.contains(secondText)) {
              ...
              //  LogUtils.verbose("init1 select second text: " + st + ", index:" + selectedSecondIndex);
                break;
            }
        }
        ...
        for (int k = 0; k < thirdData.size(); k++) {
            ...
            if (tt.contains(thirdText)) {
               ...
               // LogUtils.verbose("init1 select third text: " + tt + ", index:" + selectedThirdIndex);
                break;
            }
        }
    }
    ...
    public String getSelectedFirstItem() {
        selectedFirstItem = provider.provideFirstData().get(selectedFirstIndex).toString();
        return selectedFirstItem;
    }

    public String getSelectedSecondItem() {
        selectedSecondItem = provider.provideSecondData(selectedFirstIndex).get(selectedSecondIndex).toString();
        return selectedSecondItem;
    }

    public String getSelectedThirdItem() {
        selectedThirdItem = provider .provideThirdData(selectedFirstIndex,selectedSecondIndex).get(selectedThirdIndex).toString();
...
//        wheelParams2.weight = 1;
     ...
     * 数据提供接口
     */
    public interface DataProvider<E1,E2,E3> {
         ...
         * 提供第一级数据
         */
        List<E1> provideFirstData();

        /**
         * 提供第二级数据
         */
        List<E2> provideSecondData(int firstIndex);

        /**
         * 提供第三级数据
         */
        List<E3> provideThirdData(int firstIndex, int secondIndex);
