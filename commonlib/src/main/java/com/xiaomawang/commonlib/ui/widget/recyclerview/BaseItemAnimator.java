...
/**
 * Created by jiayazhou on 2018/3/26.
 */
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(view, mover, getMoveDelayed());//getRemoveDuration()
            } else {
                mover.run();
            }
        }
        ...
        if (changesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(holder.itemView, changer, getChangeDelayed());
            } else {
                changer.run();
            }
        }
     ...
     * @return
     */
    public abstract long getMoveDelayed();
     ...
     * @return
     */
    public abstract long getChangeDelayed();
}
