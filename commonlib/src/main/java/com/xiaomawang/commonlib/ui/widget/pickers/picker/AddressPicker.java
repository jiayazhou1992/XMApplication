...
import com.xiaomawang.commonlib.ui.widget.pickers.listeners.OnLinkageListener;
...
public class AddressPicker extends LinkagePicker {
     ...
     * 地址提供者
     */
    public static class AddressProvider implements DataProvider<String, String, String> {
