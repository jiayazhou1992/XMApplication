...
public class RoundedCornersTransform implements Transformation<Bitmap> {
    private static final String ID = "com.xiaomawang.commonlib.ui.widget.RoundedCornersTransform";
    ...
    public Resource<Bitmap> transform(@NonNull Context context, @NonNull Resource<Bitmap> resource, int outWidth, int outHeight) {
        ...
        if (width != 0 || height != 0) {
            ...
            float sx = source.getWidth() * 1f / finalWidth;
            float sy = source.getHeight() * 1f / finalHeight;
            matrix.setScale(1/sx, 1/sy);
