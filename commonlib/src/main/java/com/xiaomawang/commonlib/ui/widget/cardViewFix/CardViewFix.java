...
package com.xiaomawang.commonlib.ui.widget.cardViewFix;
 ...
 */
public class CardViewFix extends FrameLayout {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        public boolean getUseCompatPadding() {
            return CardViewFix.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return CardViewFix.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            CardViewFix.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                CardViewFix.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                CardViewFix.super.setMinimumHeight(height);
            }
        }
        ...
        public View getCardView() {
            return CardViewFix.this;
        }
    };

    public CardViewFix(@NonNull Context context) {
        this(context, null);
    }

    public CardViewFix(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    public CardViewFix(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CardViewFix, defStyleAttr,
                R.style.CardViewFix);
        ColorStateList backgroundColor;
        if (a.hasValue(R.styleable.CardViewFix_cardBackgroundColor)) {
            backgroundColor = a.getColorStateList(R.styleable.CardViewFix_cardBackgroundColor);
        } else {
        ...
        ColorStateList shadowColorStart = a.getColorStateList(R.styleable.CardViewFix_cardShadowColorStart);
        ColorStateList shadowColorEnd = a.getColorStateList(R.styleable.CardViewFix_cardShadowColorEnd);
        float radius = a.getDimension(R.styleable.CardViewFix_cardCornerRadius, 0);
        float elevation = a.getDimension(R.styleable.CardViewFix_cardElevation, 0);
        float maxElevation = a.getDimension(R.styleable.CardViewFix_cardMaxElevation, 0);
        mCompatPadding = a.getBoolean(R.styleable.CardViewFix_cardUseCompatPadding, false);
        mPreventCornerOverlap = a.getBoolean(R.styleable.CardViewFix_cardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(R.styleable.CardViewFix_contentPadding, 0);
        mContentPadding.left = a.getDimensionPixelSize(R.styleable.CardViewFix_contentPaddingLeft,
                defaultPadding);
        mContentPadding.top = a.getDimensionPixelSize(R.styleable.CardViewFix_contentPaddingTop,
                defaultPadding);
        mContentPadding.right = a.getDimensionPixelSize(R.styleable.CardViewFix_contentPaddingRight,
                defaultPadding);
        mContentPadding.bottom = a.getDimensionPixelSize(R.styleable.CardViewFix_contentPaddingBottom,
                defaultPadding);
