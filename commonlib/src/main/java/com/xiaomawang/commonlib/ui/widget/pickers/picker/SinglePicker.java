...
import com.xiaomawang.commonlib.ui.widget.pickers.listeners.OnSingleWheelListener;
...
public class SinglePicker<T> extends WheelPicker {
    ...
    public void setItemWidth(int itemWidth) {
        if(wheelModeEnable){
            if (null != wheelView) {
                wheelView.setLayoutParams(new LinearLayout.LayoutParams(itemWidth, wheelListView.getLayoutParams().height));
            }else{
                this.itemWidth = SizeUtils.pxConvertDip(itemWidth);
            }
        }
        else {
            if (null != wheelListView) {
                wheelListView.setLayoutParams(new LinearLayout.LayoutParams(itemWidth, wheelListView.getLayoutParams().height));
            }else{
                this.itemWidth = SizeUtils.pxConvertDip(itemWidth);
            }
        }
     ...
     * 设置选项的宽(dp)
     */
    public void setItemWidthDp(int itemWidth) {
        if(wheelModeEnable){
            if (null != wheelView) {
