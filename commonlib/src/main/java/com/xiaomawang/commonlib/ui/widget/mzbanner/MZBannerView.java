package com.xiaomawang.commonlib.ui.widget.mzbanner;
...
import com.xiaomawang.commonlib.ui.widget.mzbanner.holder.MZHolderCreator;
import com.xiaomawang.commonlib.ui.widget.mzbanner.holder.MZViewHolder;
import com.xiaomawang.commonlib.ui.widget.mzbanner.transformer.CoverModeTransformer;
import com.xiaomawang.commonlib.ui.widget.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private void readAttrs(Context context, AttributeSet attrs){
        ...
        mIndicatorRes[0] = typedArray.getResourceId(R.styleable.MZBannerView_indicatorunSelectRes, R.drawable.indicator_normal);
        mIndicatorRes[1] = typedArray.getResourceId(R.styleable.MZBannerView_indicatorSelectRes, R.drawable.indicator_selected);
        typedArray.recycle();
    }
        ...
        for(int i=0;i<mDatas.size();i++){
            ...
            if(mIndicatorAlign == IndicatorAlign.LEFT.ordinal()){
                if(i == 0){
                    ...
                    imageView.setPadding(paddingLeft+ padding,0,padding,0);
                } else{
                ...
                if(i == mDatas.size() - 1){
                    ...
                    imageView.setPadding(padding,0,padding + paddingRight,0);
                }else{
                    imageView.setPadding(padding,0,padding,0);
                }
