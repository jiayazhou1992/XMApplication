...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        @SuppressLint("RestrictedApi") TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, styleable.TabLayout, defStyleAttr, style.Widget_Design_TabLayout, new int[]{styleable.TabLayout_tabTextAppearance});
    ...
    class TabView extends LinearLayout {
        ...
        private void updateBackgroundDrawable(Context context) {
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                @SuppressLint("RestrictedApi") ColorStateList rippleColor = RippleUtils.convertToRippleDrawableColor(TabLayout.this.tabRippleColorStateList);
                if (VERSION.SDK_INT >= 21) {
        ...
        final void update() {
            ...
            if (custom != null) {
                ...
                this.customTextView = custom.findViewById(android.R.id.text1);
                if (this.customTextView != null) {
                    this.defaultMaxLines = TextViewCompat.getMaxLines(this.customTextView);
                }

                this.customIconView = custom.findViewById(android.R.id.icon1);
            } else {
                if (this.customView != null) {
