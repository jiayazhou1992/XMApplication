...
public class LogConfig {
	...
	public boolean isOutputMethodAll = LogConstants.JUDGE_OUTPUT_METHOD_ALL;

	/** 显示日志线程信息(特殊情况,显示经过的线程信息,具体情况如上) = 默认 false */
	public boolean isDisplayThreadInfo = LogConstants.JUDGE_DISPLAY_THREAD_LOG;
	
	/** 是否排序日志(格式化) = 默认 false */
	public boolean isSortLog = LogConstants.JUDGE_SORT_LOG;
