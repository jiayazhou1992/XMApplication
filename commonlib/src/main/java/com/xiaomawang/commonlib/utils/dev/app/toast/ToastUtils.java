package com.xiaomawang.commonlib.utils.dev.app.toast;
...
public final class ToastUtils {
			...
			try {
				if (mToast != null) {
					...
					if (context != null) {
						...
						mToast.setView(getToastView(context));
                        mToast.setDuration(duration);
                        mToast.setText(text);
					}
				}
	...
	private static View getToastView(Context context){
		View toastView = LayoutInflater.from(context).inflate(R.layout.layout_toast, null, false);
		return toastView;
	}
