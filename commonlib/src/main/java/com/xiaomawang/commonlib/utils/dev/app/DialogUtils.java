...
public final class DialogUtils {
     ...
     * @return
     */
    public static AlertDialog createAlertDialog(Context context, String title, String content, CharSequence leftBtn, CharSequence rightBtn, final DialogListener dialogListener){
